...
const AboutUsPage = () => {
  return (
    <section className="relative">
      ...
      <div className="p-5 md:p-20 grid place-items-center text-center text-xl md:text-base">
        <p>
          ...
          users like you! Keep up to date with New Releases and wha's Coming
          Soon in Wix ellaneous in Support. Feel free to tell us what you think
