...
const HomePage = () => {
  return (
    <div>
      <section
        className="    grid place-items-center   w-full h-screen bg-cover bg-center bg-no-repeat border-x-28 border-white "
        style={{ backgroundImage: `url(${homepic})` }}
      >
        <div className="absolute inset-0 bg-black opacity-60 border-x-28 border-white"></div>
      </section>

      <div className="">
        <section className=" grid place-items-center ">
          <div className="absolute top-85 text-8xl w-220 text-center text-white ">
            <h1>
              A MECHANIC <br />
              YOU CAN TRUST
            </h1>
          </div>
          <div className="absolute top-145 grid grid-cols-3 place-content-center text-center ">
